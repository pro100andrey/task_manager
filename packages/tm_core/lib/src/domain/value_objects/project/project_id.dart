...
extension type const ProjectId._(String value) {
  factory ProjectId(String value) {
    if (!UuidValidation.isValidUUID(fromString: value)) {
      throw FormatException('Invalid UUID format for ProjectId: $value');
    }

    return ProjectId._(value);
  }
